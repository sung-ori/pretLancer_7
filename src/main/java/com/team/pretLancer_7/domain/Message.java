...
public class Message {
    ...
    public String messagetype; // 메세지의 타입을 명명
    public String memberid; // 메세지를 받는 대상
    public String sender; // 메세지를 발행하는 주체나 메세지를 생성한 주체
    ...
    // TODO: 메세지 삽입 테스트, 출력 테스츠, 자바스크립크 코드, 리워드 결제 수단 추가, 리워드 돌려받는 이메일 전송.
}
